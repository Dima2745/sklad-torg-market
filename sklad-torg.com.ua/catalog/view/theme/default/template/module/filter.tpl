<div class="box">
  ...
  <div class="box-content">
    <ul class="box-filter">
      ...
      <li><span id="filter-group<?php echo $filter_group['filter_group_id']; ?>" style="font-size:15px; color: rgb(0,0,255); font-weight:bold; margin-left: -25px;"><?php echo $filter_group['name']; ?></span>
        <ul>
