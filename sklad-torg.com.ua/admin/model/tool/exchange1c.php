...
//                    $data['location'] = isset($sklad) ? (string)$sklad : "Нет в наличии";
                    ...
                    } else if($offer->Склад[2][КоличествоНаСкладе] !=0){
...
//					if($sklad == "6d7ea463-918a-11e7-bcdf-4675de653243"){
//					    $sklad = "Дарница";
//                        $data['location'] = isset($sklad) ? (string)$sklad : "Нет в наличии";
//                    } else {
//                        $data['location'] = isset($offer->Склад[2][ИдСклада]) ? (string)$offer->Склад[2][ИдСклада] : "Нет в наличии";
//                    }
//                    $data['location'] = isset($val) ? (string)$val : "Нет в наличии";
...
//                            'location'                => isset($data['location']) ? (string)$data['location'] : "Лепсе",
							...
							$product_option_value_data[] = array(
								...
								'location'                => isset($sklad) ? (string)$sklad : "Нет в наличии",
								'subtract'                => 0,
							...
							if ($exchange1c_relatedoptions) {
								...
								if (!$ro_found) {
									$data['relatedoptions'][] = array('char_id' => $char_id, 'quantity' => (isset($offer->Количество) ? (int)$offer->Количество : 0), 'location' =>(isset($sklad) ? (string)$sklad : "Нет в наличии"),'options' => array($option_id => $option_value_id));
								}
...
//			,'location'     => (isset($product['location'])) ? $product['location'] : (isset($data['location']) ? $data['location']: '')
			...
			,'location'     => (isset($product['location'])) ? $product['location'] : (isset($data['location']) ? $data['location']: "Нет в наличии")
